...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg bg-primary bg-body-tertiary" data-bs-theme="dark">
            <div class="container">
                <a class="navbar-brand mb-0 h1" href="{{ route('index') }}">Ocid Store</a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="{{ route('category') }}">Caetogories</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('cart') }}"><i
                                    class="fa-solid me-2 fa-cart-shopping"></i>Cart</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <footer>
        <!-- place footer here -->
        <div class="container-fluid text-center mt-5 p-3 bg-primary">
